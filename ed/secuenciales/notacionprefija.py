...
class Prefija:
    ...
    Se utiliza la clase pila o stack para los diferentes
    algoritmos de manejo. También se crea una clase llamada
    Operador.
    """
    
    def __init__(self,expresión_infija:str):
        """Constructor de la clase Prefija.
        En este método se inicializan la lista de operadores
        a través del uso de la clase Operador, y se crea una nueva
        expresión.

        :param expresión_infija: Expresión infija sin formateado
        :type expresión_infija: str
        """     
    ...
    def infija(self):
        """Método que retorna la expresión Infija original,
        separando cada operando y cada operador, incluyendo 
        los paréntesis, por un espacio en blanco.


        :return: Cadena con la expresión infija formateada
        :rtype: str
        """ 
    ...
    def prefija(self):
        """Método que convierte una expresión Infija a una 
        expresión Prefija, haciendo uso de una Pila. Retorna
        la cadena de la expresión Prefija separando los operandos
        y operadores por un espacio en blanco.

        :return: Cadena con la expresión infija transformada a infija
        :rtype: str
        """  
    ...
    def eval_expr_aritm(self):
        ...
        utilizando una Pila, calculando y retornando el resultado final de la expresión.

        :return: Valor con el resultado numérico de la expresión
        :rtype: float
        """    
...
class Operador:
    """Clase que representa un operador matemático asignado por un
    caracter, una prioridad en la expresión, y una prioridad en la pila.
    """

    def __init__(self,operador,prio_expr,prio_pila):
        """Constructor de la clase Operador

        :param operador: Operador recibido como caracter
        :type operador: char
        :param prio_expr: Prioridad del operador en la expresión
        :type prio_expr: int
        :param prio_pila: Prioridad del operador en la pila
        :type prio_pila: int
        """    
